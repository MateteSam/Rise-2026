  ...
  head: () => ({
    meta: [
      ...
      { title: "Rise, South African Woman 2026 — GWFSN Women's Day Conference" },
      {
        name: "description",
        content:
          "Join the Global Women's Future Skills Network in Rosebank or online on 8 August 2026 for an inspiring Women's Day conference on confidence, leadership, transformation and future-fit skills.",
      },
