...
export const HIGHLIGHTS = [
  {
    ...
    body: "Reflect on the women, experiences and values that have shaped your life.",
  },
  {
    title: "Strengthen Your Confidence",
    body: "Discover practical approaches to self-mastery, authentic presence and intentional growth.",
  },
  {
    title: "Renew Your Purpose",
    body: "Explore resilience, reinvention, emotional wellbeing and the courage to move forward.",
  },
  {
    title: "Prepare for the Future",
    body: "Build greater awareness of the skills, adaptability and visibility required in a changing world.",
  },
  {
    title: "Connect Meaningfully",
    body: "Meet professionals, entrepreneurs, mentors, emerging leaders and community builders.",
  },
  {
    title: "Learn from Powerful Voices",
    body: "Hear from an exceptional line-up of speakers from South Africa, Nigeria and the United Kingdom.",
  },
];
...
export const SPEAKERS: Speaker[] = [
  ...
  },
  {
    ...
    themes: [
      ...
      "Intentional growth",
      "Grounding and embodied confidence",
    ],
    accent: "orange",
    image: "spk-joy",
  },
  {
    ...
    themes: [
      ...
      "Engaging hybrid audiences",
      "Leading the closing charge",
    ],
    accent: "violet",
    image: "spk-bess",
  },
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "The R499 in-person attendance contribution is allocated entirely to the participant's food and refreshments at the venue restaurant.",
  },
  {
    q: "Is there a separate conference admission fee?",
    a: "There is no separate conference admission fee included in the R499 contribution.",
  },
  {
    q: "What is included in the in-person experience?",
    a: "The reservation includes access to the conference programme, food and refreshments, networking opportunities, interactive activities and selected post-event resources.",
  },
  {
    q: "What should I wear?",
    a: "Elegant, confident and proudly expressive. Guests are encouraged to wear an outfit that makes them feel powerful and celebration-ready.",
  },
  {
    q: "Can I transfer my reservation?",
    a: "Reservations may be transferred to another guest before the final catering deadline, subject to written notification.",
  },
  {
    q: "Can organisations make group bookings?",
    a: "Yes. Corporate teams, women's forums, professional associations, universities and community groups are encouraged to attend.",
  },
  {
    q: "Will photographs and videos be taken?",
    a: "Photography and video recording may take place during the event. The final photography and recording notice will be included in the registration terms.",
  },
];
